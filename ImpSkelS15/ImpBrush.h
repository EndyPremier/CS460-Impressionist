...
public:
  ...
  // The implementation of your brush should realize these virtual functions
  //virtual void RightBegin(const Point source, const Point target) = 0;
  //virtual void RightMove(const Point source, const Point target) = 0;
  //virtual void RightEnd(const Point source, const Point target) = 0;
